...
export default function Page({params}){
    ...
    const getUserDetails = async () => {
        ...
        console.log("🚀 ~ file: page.js:20 ~ getUserDetails ~ data:", data.result[0].name)
    ...
    return(
        <div>
            ...
            <input type="text" placeholder="Enter Website" value={website} onChange={(e)=>setWebsite(e.target.value)} />
